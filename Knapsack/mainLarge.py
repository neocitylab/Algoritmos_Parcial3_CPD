...
val = [243, 370, 145, 266, 342, 15, 13, 278, 168, 88, 91, 157, 414, 425, 354, 146, 268, 314, 63, 460, 114, 157, 363, 324, 236,
...
wt = [7, 1, 29, 49, 35, 11, 46, 8, 26, 22, 41, 5, 47, 41, 43, 16, 44, 9, 28, 20, 40, 8, 33, 27, 42, 40, 31, 39, 34, 1, 
...
for i in range(10):
    ...
    with open("large.csv", "a") as archivo:
